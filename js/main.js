...
const AUDIO_DETAIL = [
	{
		...
		dialog: {
			Japanese: [
				"こ、これでもう良くない？そろそろ降りようよ……",
				"もうやめたいとか、そういうんじゃないんだけど……"
			],
			English: [
				"I think that should be enough. Let me get off this thing.",
				"It's not that I want to stop or anything, but..."
			],
			Chinese: [
				"这，这样差不多就可以了吧？差不多该下来了……",
				"虽然没打算放弃……"
			]
		}
	},
	{
		...
		dialog: {
			Japanese: [
				"ちょ、ちょっと！！先生！何すんのよ！揺れるでしょ！",
				"このボート、ひっくり返りやすいんだから！！やめて！"
			],
			English: [
				"W-Wait!! What are you doing, Sensei?! You're rocking it!",
				"Y-You're going to flip it over! Stop it!"
			],
			Chinese: [
				"等、等下！！老师！您在干嘛！太晃了吧！",
				"这个小艇很容易翻啊！！快停下来！"
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"What do you mean, \"this will be fun\"?!",
				"Sensei, quit messing with me!"
			],
			Chinese: [
				"不是，什么叫感觉很有意思啊。",
				"老师，别拿别人找乐子啊。"
	...
	},
	{
		...
		dialog: {
			Japanese: [
				"……はあ。もういいわよ。先生はそういう人だったわね。",
				"こういう事するって予想できてたはずなのに……"
			],
			English: [
				"...Ah... Never mind. This is just like you, you know.",
	...
	},
	{
		...
		dialog: {
			Japanese: [
				"まぁいいわ。私もちょっと思いついたことがあるから。",
				"さあ、先生！交代よ！！今度は先生の番よ！"
			],
			English: [
				"Oh, it's fine. I just had an idea...",
				"All right, Sensei! It's your turn now!"
			],
			Chinese: [
				"嘛算了。刚好我也想到一个好点子。",
				"来吧，老师！到我了！这次轮到老师了！"
...
const HITBOX = {
	headpat: { xMin: 450, xMax: 1050, yMin: 200, yMax: 550 },
	voiceline: { xMin: 880, xMax: 1860, yMin: 785, yMax: 1300 }
};
